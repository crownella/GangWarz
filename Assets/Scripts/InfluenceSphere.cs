...
public class InfluenceSphere : MonoBehaviour
{
    ...
    private void OnTriggerEnter(Collider other)
    {
        ...
        if (other.transform.tag == "GangMember") //if you collide with a gang member and u werent the last leadre to influence them && !other.gameObject.GetComponent<CubeController>().lastInfluenceLeader == GetComponentInParent<Transform>().gameObject
        {
    ...
    {
        if(other.transform.tag == "GangMember")
        {
